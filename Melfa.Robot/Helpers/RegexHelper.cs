...
#else
        private static readonly Lazy<Regex> _ErrorRegex = new Lazy<Regex>(() => new Regex(ErrorRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex ErrorRegex() => _ErrorRegex.Value;

        private static readonly Lazy<Regex> _HandStateRegex = new Lazy<Regex>(() => new Regex(HandStateRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex HandStatesRegex() => _HandStateRegex.Value;

        private static readonly Lazy<Regex> _InfoRegex = new Lazy<Regex>(() => new Regex(InfoRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex InfoRegex() => _InfoRegex.Value;

        private static readonly Lazy<Regex> _RunStateRegex = new Lazy<Regex>(() => new Regex(RunStateRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex RunStateRegex() => _RunStateRegex.Value;

        private static readonly Lazy<Regex> _PositionJointRegex = new Lazy<Regex>(() => new Regex(PositionJointRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex PositionJointRegex() => _PositionJointRegex.Value;

        private static readonly Lazy<Regex> _PositionJointPosRegex = new Lazy<Regex>(() => new Regex(PositionJointPosRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex PositionJointPosRegex() => _PositionJointPosRegex.Value;

        private static readonly Lazy<Regex> _PositionJointAxisRegex = new Lazy<Regex>(() => new Regex(PositionJointAxisRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex PositionJointAxisRegex() => _PositionJointAxisRegex.Value;

        private static readonly Lazy<Regex> _PositionXyzRegex = new Lazy<Regex>(() => new Regex(PositionXyzRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex PositionXyzRegex() => _PositionXyzRegex.Value;

        private static readonly Lazy<Regex> _PositionXyzPosRegex = new Lazy<Regex>(() => new Regex(PositionXyzPosRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
        public static Regex PositionXyzPosRegex() => _PositionXyzPosRegex.Value;

        private static readonly Lazy<Regex> _PositionXyzAxisRegex = new Lazy<Regex>(() => new Regex(PositionXyzAxisRegexPattern, RegexOptions.ExplicitCapture | RegexOptions.Compiled));
